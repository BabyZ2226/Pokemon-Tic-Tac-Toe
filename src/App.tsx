...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 md:p-8">
      ...
      >
        <h1 className="text-4xl md:text-6xl font-display font-black tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-red-500 mb-2">
          POKÉMON TRICKI
        </h1>
        <p className="text-slate-400 font-medium">Trivia Grid x Tres en Línea</p>
      </motion.div>
